...
test.describe('TS01 - Login', async () => {
    ...
    test('TC004 - edit agent admin details', async () => {
        ...
        await agentPage.editAgentAdminDetails("akr", "65300756", "aru24@medyaan.com","Rate Card 2","Singapore","www.yaantrac.com");
        await agentPage.clickSaveBtn();
    ...
    test('TC006 - add agent admin details with invalid data', async () => {
        const agentPage = new AgentPage(page);
        await agentPage.clickAddOperationAdminBtn();
        await agentPage.clickSaveBtn();
    ...
    //     const agentPage = new AgentPage(page);
    //     await agentPage.navigateToOperationUserTab();
    //     await page.waitForTimeout(2000);
    ...
    //     const agentPage = new AgentPage(page);
    //     await agentPage.clickAddOperationUserBtn();
    //     await agentPage.clickCancelBtn();
    //     await agentPage.clickAddOperationUserBtn();
    //     await agentPage.addOperationUserDetails("ribha", "ARUN", "60004500", "ribha@medyaan.com", "ribhab", "Arun@123", "Arun@123");
    //     await agentPage.passwordEyeIcon.click();
    //     await agentPage.passwordEyeIcon.click();
    //     await agentPage.confirmPasswordEyeIcon.click();
    //     await agentPage.confirmPasswordEyeIcon.click();
    ...
    //     const agentPage = new AgentPage(page);
    //     await agentPage.searchValue('');
    //     await agentPage.searchValue('Ribha');
    //     await agentPage.clickUpdateBtn();
    //     await agentPage.editOperationUserDetails("ARUN", "65320083", "ribha.b@dataan.com");
    //     await agentPage.clickSaveBtn();
    //     await agentPage.validateToastMessage('User profile updated successfully');
    //     await page.waitForTimeout(2000);
    // })
