...
test.describe.serial('TS01 - Login', async () => {
    ...
    test('TC005 - if it is standard', async () => {
        const bookingsPage = new BookingsPage(page);
        const excelReader = new ExcelReader();
        const bookingdata = await excelReader.readExcel("C:/Users/TamilselviArul/Downloads/Autoplannerdata.xlsx", "Bookings");
        const { StandardTourName } = bookingdata[0];
        await bookingsPage.standard(StandardTourName);
    })
    ...
    test('TC014 - Cancel Filter', async () => {
        const bookingsPage = new BookingsPage(page);
        await bookingsPage.clickclearfilter();
    ...
    test('TC016 - search sic', async () => {
        ...
        const excelReader = new ExcelReader();
        const bookingdata = await excelReader.readExcel("C:/Users/TamilselviArul/Downloads/Autoplannerdata.xlsx", "Bookings");
        const { SICSearch, GuestName } = bookingdata[0];
        await bookingsPage.searchSIC(SICSearch);
        //await bookingsPage.updatethebookings(GuestName);
        //await bookingsPage.canceldeletethebooking();

    })

    test('TC017 - search Tsic', async () => {
        const bookingsPage = new BookingsPage(page);
        const excelReader = new ExcelReader();
        const bookingdata = await excelReader.readExcel("C:/Users/TamilselviArul/Downloads/Autoplannerdata.xlsx", "Bookings");
        const { TSICSearch, GuestName } = bookingdata[0];
        await bookingsPage.searchTSIC(TSICSearch);
        //await bookingsPage.updatethebookings(GuestName);
        //await bookingsPage.canceldeletethebooking();
    })

    test('TC018 - search PVT', async () => {
        const bookingsPage = new BookingsPage(page);
        const excelReader = new ExcelReader();
        const bookingdata = await excelReader.readExcel("C:/Users/TamilselviArul/Downloads/Autoplannerdata.xlsx", "Bookings");
        const { PVTSearch, GuestName } = bookingdata[0];
        await bookingsPage.searchPVT(PVTSearch);
        //await bookingsPage.updatethebookings(GuestName);
        //await bookingsPage.canceldeletethebooking();
    })

    test('TC019 - search GRP', async () => {
        const bookingsPage = new BookingsPage(page);
        const excelReader = new ExcelReader();
        const bookingdata = await excelReader.readExcel("C:/Users/TamilselviArul/Downloads/Autoplannerdata.xlsx", "Bookings");
        const { GRPSearch, GuestName } = bookingdata[0];
        await bookingsPage.searchGRP(GRPSearch);
        //await bookingsPage.updatethebookings(GuestName);
        //await bookingsPage.canceldeletethebooking();
    })
    test('TC020 - search RLR', async () => {
        const bookingsPage = new BookingsPage(page);
        const excelReader = new ExcelReader();
        const bookingdata = await excelReader.readExcel("C:/Users/TamilselviArul/Downloads/Autoplannerdata.xlsx", "Bookings");
        const { RLRSerach} = bookingdata[0];
        await bookingsPage.searchRLR(RLRSerach
);
    })

    test('TC021 - Import', async () => {
        const bookingsPage = new BookingsPage(page);
        const excelReader = new ExcelReader();
        const bookingdata = await excelReader.readExcel("C:/Users/TamilselviArul/Downloads/Autoplannerdata.xlsx", "Bookings");
        const { FilePath} = bookingdata[0];
        await bookingsPage.import(FilePath);
    })
     test('TC022 - CancelImport ', async () => {
        const bookingsPage = new BookingsPage(page);
        const excelReader = new ExcelReader();
        await bookingsPage.cancel_import();
    })
    test.skip('TC023 - Save Import ', async () => {
        const bookingsPage = new BookingsPage(page);
        const excelReader = new ExcelReader();
        await bookingsPage.Saveimport();
    })
